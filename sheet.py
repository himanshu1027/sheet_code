...
def update_google_sheet_data(google_sheet_link, worksheet_name, data,api_key, range=None):
  ...
  if range is not None:
    ...
    # Append the data to the existing data in the spreadsheet.
    request = sheets_service.spreadsheets().values().append(spreadsheetId=spreadsheet_id, range="A2", valueInputOption="USER_ENTERED", body=body,key=api_key)
...
data = [['21/10/2023', "hye data", 'URL'], ['22/10/2023', "hye data", 'URL'], ['23/10/2023', "hye data", 'URL']]
